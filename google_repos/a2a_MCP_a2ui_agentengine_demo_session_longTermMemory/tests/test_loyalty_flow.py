...
def run_test():
    # --- PHASE 1: Loyalty Campaign Init Query ---
    print("\n==================================================")
    print("PHASE D.1: Sending Loyalty campaign init query to Supervisor")
    print("==================================================")
    
    payload = {
        "message": {
            "role": "ROLE_USER",
            "message_id": "loyalty-msg-1",
            "context_id": "loyalty-test-session",
            "content": [
                {
                    "text": "Initiate loyalty rewards personalization campaign for Diet Pepsi cohort"
                }
            ]
        }
    }
    ...
    assert len(a2ui_parts) > 0, "Error: No A2UI parts returned by Supervisor for loyalty initialization!"
    assert "circana-loyalty-dashboard" in str(a2ui_parts), "Error: circana-loyalty-dashboard was not in the A2UI payloads!"
    print("\n✓ Phase D.1 Successful! Dashboard rendered correctly.")

    # --- PHASE 2: Launch Campaign (Callback action) ---
    print("\n==================================================")
    print("PHASE D.2: Sending Launch Campaign callback action")
    print("==================================================")
    ...
    print("\n--- Final Campaign Text Response ---")
    print(last_text_b)
    
    assert "Successfully launched personalized campaign for Diet Pepsi" in last_text_b or "Success" in last_text_b, "Error: Campaign launch confirmation was missing!"
    print("\n✓ Phase D.2 Successful! Loyalty personalization campaign launched successfully.")
    print("\n==================================================")
    print("ALL A2A LOYALTY TESTS PASSED SUCCESSFULLY!")
    print("==================================================")
